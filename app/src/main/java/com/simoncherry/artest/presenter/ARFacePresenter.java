...
public class ARFacePresenter implements ARFaceContract.Presenter {
    ...
    public List<Ornament> getPresetOrnament() {
        ...
        ornaments.add(getSnowman());
        ornaments.add(getDearHat());
        ornaments.add(getCap());
        ornaments.add(getMouse());
        ornaments.add(getFox());
        return ornaments;
    }
    ...
    private Ornament getGlass() {
        ...
        ornament.setScale(0.006f);
        ornament.setOffset(0, -0.04f, 0.2f);
    ...
    private Ornament getTigerNose() {
        ...
        ornament.setScale(0.0014f);
        ornament.setOffset(0, -0.31f, 0.2f);
        ornament.setRotate(0.0f, 0.0f, 0.0f);
        ornament.setColor(0xffe06666);
        return ornament;
    }
    ...
    private Ornament getVMask() {
        ...
        ornament.setScale(0.134f);
        ornament.setOffset(0, -0.107f, 0.0f);
    ...
    private Ornament getCatMask() {
        ...
        ornament.setOffset(0, -0.105f, -0.1f);
        ornament.setRotate(0, 0, 0);
    ...
    private Ornament getSnowman() {
        Ornament ornament = new Ornament();
        ornament.setModelResId(R.raw.snowman_obj);
        ornament.setImgResId(R.drawable.ic_snowman);
        ornament.setScale(0.6f);
        ornament.setOffset(0, -0.52f, 0.0f);
        ornament.setRotate(0, 0, 0);
        ornament.setColor(NO_COLOR);
        return ornament;
    }
    ...
    private Ornament getDearHat() {
        Ornament ornament = new Ornament();
        ornament.setModelResId(R.raw.dearhat_obj);
        ornament.setImgResId(R.drawable.ic_dearhat);
        ornament.setScale(0.7f);
        ornament.setOffset(0, -0.3f, 0.0f);
        ornament.setRotate(0, 0, -15.f);
        ornament.setColor(NO_COLOR);
        return ornament;
    }


    private Ornament getCap() {
        Ornament ornament = new Ornament();
        ornament.setModelResId(R.raw.cap_obj);
        ornament.setImgResId(R.drawable.ic_cap);
        ornament.setScale(0.006f);
        ornament.setOffset(0.1f, -0.5f, 0.0f);
        ornament.setRotate(-5f, 45f, -40f);
        ornament.setColor(NO_COLOR);
        return ornament;
    }

    private Ornament getMouse() {
        Ornament ornament = new Ornament();
        ornament.setModelResId(R.raw.mouse_obj);
        ornament.setImgResId(R.drawable.ic_mouse);
        ornament.setScale(0.7f);
        ornament.setOffset(0, 0.5f, -0.2f);
        ornament.setRotate(0.0f, 0.0f, 0.0f);
        ornament.setColor(NO_COLOR);
        return ornament;
    }

    private Ornament getFox() {
        Ornament ornament = new Ornament();
        ornament.setModelResId(R.raw.fox_obj);
        ornament.setImgResId(R.drawable.ic_fox);
        ornament.setScale(0.6f);
        ornament.setOffset(0, 0.45f, -0.2f);
        ornament.setRotate(0.0f, 0.0f, -30f);
        ornament.setColor(NO_COLOR);
        return ornament;
    }
